...
-- sqlcmd -S localhost -d OnlineClothingShop -Q "EXEC ExportProductsToJSON" -o "C:\Users\user\Desktop\лк, экз\бд\3 курс\кп\DB_KP\json\Products.json" -h -1 -r 1 -y 8000
...
from openrowset(
  bulk 'C:\Users\user\Desktop\лк, экз\бд\3 курс\кп\DB_KP\json\Products.json',
  single_clob
) as j;
...
select @json = BulkColumn
from openrowset(
  bulk 'C:\Users\user\Desktop\лк, экз\бд\3 курс\кп\DB_KP\json\Logs.json',
  single_clob
) as j;
